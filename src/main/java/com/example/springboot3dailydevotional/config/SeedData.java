...
public class SeedData implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    if (devotions.size() < 1) {
      ...
      devo1.setImagePath("images/1.jpg");
      devo1.setQuote("To be or not to be");
      devo1.setAuthor("author 1");
      ...
      devo2.setImagePath("images/2.jpg");
      devo2.setQuote("That is the Question.");
      devo2.setAuthor("author 2");
      ...
      devo3.setImagePath("images/3.jpg");
      devo3.setQuote("This is the next thing.");
      devo3.setAuthor("author 3");
